...
| `cvelist` | `list[str]` | 60% | Related CVE identifiers referenced by this document. | `["CVE-2026-53359"]` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 60% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-53359", "date": "2026-07-1…` |
...
| `metrics` | `object{adp,cna,nvd}, object{adp,cna}, object{cna}` | 60% | Raw scoring metrics blob (CNA/ADP/NVD/vendor sub-objects). | `{"cna": {"cvss31": {"source": "nvd", "version…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-14T12:29:35.425000Z", "u…` |
