...
| `cvss4` | `object{cvssV4}` | 45% | CVSS v4.0 score block. | `{"cvssV4": {"source": "security@joomla.org", …` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-06-17T05:43:59.841000Z", "u…` |
