...
**Family model:** [`AdvisoryBulletin`](../../data-models.md) — `bulletinFamily: nozomi`. Fields beyond the model stay accessible via `extra="allow"`; *in samples* is how often the field appeared in the sampled documents.
