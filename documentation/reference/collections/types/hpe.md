...
| `cvss4` | `object{cvssV4}` | 50% | CVSS v4.0 score block. | `{"cvssV4": {"source": "security-advisories@gi…` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 10% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2025-48989", "date": "2026-07-1…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-14T21:41:13.128000Z", "u…` |
