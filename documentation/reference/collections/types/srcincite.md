...
| `cvelist` | `list[str]` | Related CVE identifiers referenced by this document. | `["CVE-2026-25200"]` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-25200", "date": "2026-06-1…` |
...
| `viewCount` | `int` | How many times the document has been viewed on Vulners. | `136` |
...
Specific to the `srcincite` collection.
