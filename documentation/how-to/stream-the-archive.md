...
For big collections, `aiter_collection` (async only) follows the archive redirect to storage
and yields each NDJSON record lazily, so the whole archive never has to be held in memory:
