...
class AsyncAPIClient(BaseClient):
    ...
    def __init__(
        ...
        self._storage_http_client: httpx.AsyncClient | None = None
    ...
    def _new_httpx_client(self, *, http2: bool) -> httpx.AsyncClient:
    ...
    @property
    def _storage_client(self) -> httpx.AsyncClient:
    ...
    async def aclose(self) -> None:
        ...
        if self._storage_http_client is not None and not self._storage_http_client.is_closed:
            await self._storage_http_client.aclose()
