...
| `cvss` | `object{score,severity,source,vector,version}, object{score,vector}` | Primary CVSS score block (version, base score, vector, severity, source). | `{"version": "4.0", "score": 9.3, "vector": "C…` |
...
Specific to the `tibco` collection.
