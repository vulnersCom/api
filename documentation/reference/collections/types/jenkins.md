...
| `cvss3` | `object{cvssV31}` | 100% | CVSS v3.x score block. | `{"cvssV31": {"source": "jenkinsci-cert", "ver…` |
...
| `jenkinsReporter` | `str` | 85% | Reporter credited by the Jenkins advisory. | `"Suman Roy (https://linkedin.com/in/sumanrox)"` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-06-24T19:55:10.257000Z", "u…` |
