...
|---|---|---|---|---|
| `affectedSoftware` | `list[object{name,operator,version}]` | 85% | Affected software products (name/version/operator). | `[{"version": "1.20.1", "operator": "lt", "nam…` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 30% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2025-13281", "date": "2026-07-1…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-06-25T18:16:21.126000Z", "u…` |
