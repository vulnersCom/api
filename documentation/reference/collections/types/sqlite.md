...
| `type` | `str` | Source collection the document comes from (cve, exploitdb, ubuntu, …). | `"sqlite"` |
| `vhref` | `str` | URL of the document on vulners.com. | `"https://vulners.com/sqlite/SQLT:CVE-2026-11822"` |
