...
| `cvelist` | `list[str]` | 30% | Related CVE identifiers referenced by this document. | `["CVE-2026-30623"]` |
...
| `cvss3` | `object{cvssV31}` | 100% | CVSS v3.x score block. | `{"cvssV31": {"source": "snyk", "version": "3.…` |
| `cvss4` | `object{cvssV4}` | 100% | CVSS v4.0 score block. | `{"cvssV4": {"source": "snyk", "version": "4.0…` |
| `description` | `str` | 100% | Full text or summary of the vulnerability/advisory. | `"## Overview\n[chai-as-thread](https://www.np…` |
| `enchantments` | `object{dependencies,score,short_description,tags}, object{score,short_description,tags}` | 100% | Vulners-computed enrichment layer (AI score, tags, related docs). | `{"score": {"value": 5.4, "uncertanity": 1.5, …` |
| `epss` | `list[object{cve,date,epss,percentile}]` | 10% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-50289", "date": "2026-07-1…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-18T22:31:56.010000Z", "u…` |
