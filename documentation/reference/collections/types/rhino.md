...
| `metrics` | `object{adp,cna,nvd}, object{adp,cna}, object{adp,nvd}` | Raw scoring metrics blob (CNA/ADP/NVD/vendor sub-objects). | `{"cna": {"cvss31": {"source": "cve", "version…` |
...
Specific to the `rhino` collection.
