...
| `description` | `str` | Full text or summary of the vulnerability/advisory. | `"Vulnerabilities for packages: hubble, kubesc…` |
...
| `lastseen` | `str` | Last time Vulners observed/refreshed the document (ISO-8601). | `"2026-07-20T08:24:32"` |
...
| `modified` | `str` | Last modification timestamp at the source (ISO-8601). | `"2026-07-20T08:24:32"` |
...
Specific to the `wolfi` collection.
