...
| `cvelist` | `list[str]` | 65% | Related CVE identifiers referenced by this document. | `["CVE-2026-5448"]` |
...
| `cvss3` | `object{cvssV31}` | 60% | CVSS v3.x score block. | `{"cvssV31": {"source": "nvd", "version": "3.1…` |
| `cvss4` | `object{cvssV4}` | 40% | CVSS v4.0 score block. | `{"cvssV4": {"source": "facts@wolfssl.com", "v…` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 65% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-5448", "date": "2026-06-24…` |
...
| `metrics` | `object{adp,cna,nvd}, object{adp,cna}, object{nvd}` | 65% | Raw scoring metrics blob (CNA/ADP/NVD/vendor sub-objects). | `{"nvd": {"cvss31": {"source": "nvd", "version…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-05-28T07:21:58.118000Z", "u…` |
