...
| `cvss3` | `object{cvssV31}, object{cvssV3}` | 85% | CVSS v3.x score block. | `{"cvssV31": {"source": "pypa", "version": "3.…` |
| `cvss4` | `object{cvssV4}` | 30% | CVSS v4.0 score block. | `{"cvssV4": {"source": "pypa", "version": "4.0…` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 30% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-59203", "date": "2026-07-1…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-15T19:59:09.660000Z", "u…` |
