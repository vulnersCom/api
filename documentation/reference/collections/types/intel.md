...
| `cvss4` | `object{cvssV4}` | 100% | CVSS v4.0 score block. | `{"cvssV4": {"source": "secure@intel.com", "ve…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-05-12T19:16:54.910000Z", "u…` |
