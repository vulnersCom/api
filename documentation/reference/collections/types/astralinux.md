...
| `cvss3` | `object{cvssV3,cvssV31}` | 85% | CVSS v3.x score block. | `{"cvssV3": {"source": "NONE", "version": "3.0…` |
...
| `epss` | `list[object{cve,date,epss,percentile}]` | 70% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-53362", "date": "2026-07-1…` |
...
| `metrics` | `object{adp,cna,vendor}, object{adp,nvd,vendor}, object{adp}, object{cna,vendor}, object{nvd,vendor}` | 90% | Raw scoring metrics blob (CNA/ADP/NVD/vendor sub-objects). | `{"vendor": {"cvss3": {"source": "NONE", "vers…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-02T18:51:17.671000Z", "u…` |
