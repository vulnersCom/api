...
| `cvelist` | `list[str]` | 80% | Related CVE identifiers referenced by this document. | `["CVE-2026-15764", "CVE-2026-15765", "CVE-202…` |
...
| `cvss4` | `object{cvssV4}` | 20% | CVSS v4.0 score block. | `{"cvssV4": {"source": "facts@wolfssl.com", "v…` |
| `description` | `str` | 100% | Full text or summary of the vulnerability/advisory. | `"- ------------------------------------------…` |
| `enchantments` | `object{aggregatedScoring,dependencies,score,short_description,tags}, object{dependencies,score,short_description,tags}, object{score,short_description,tags}` | 100% | Vulners-computed enrichment layer (AI score, tags, related docs). | `{"score": {"value": 6.3, "uncertanity": 2.8, …` |
| `epss` | `list[object{cve,date,epss,percentile}]` | 20% | EPSS exploitation-probability forecast datapoints (score + percentile). | `[{"cve": "CVE-2026-40393", "date": "2026-07-1…` |
...
| `metrics` | `object{adp,cna,nvd}, object{adp,cna}` | 70% | Raw scoring metrics blob (CNA/ADP/NVD/vendor sub-objects). | `{"cna": {"cvss31": {"source": "chrome-cve-adm…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-07-17T07:39:25.316000Z", "u…` |
