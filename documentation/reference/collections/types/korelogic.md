...
|---|---|---|---|---|
| `affectedSoftware` | `list[object{name,operator,version}]` | 90% | Affected software products (name/version/operator). | `[{"version": "6.05.15", "operator": "eq", "na…` |
...
| `cvss3` | `object{cvssV31}` | 70% | CVSS v3.x score block. | `{"cvssV31": {"source": "nvd", "version": "3.1…` |
| `cvss4` | `object{cvssV4}` | 30% | CVSS v4.0 score block. | `{"cvssV4": {"source": "cybersecurity@se.com",…` |
...
| `timestamps` | `object{contentUpdated,created,enriched,metricsUpdated,reviewed,updated}` | 100% | Vulners lifecycle timestamps (created/updated/enriched/reviewed/…). | `{"created": "2026-01-08T21:27:06.491000Z", "u…` |
